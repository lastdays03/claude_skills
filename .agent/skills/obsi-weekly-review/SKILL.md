...
2.  **Context Loading**: `this document`를 읽어 'GTD Style' 리뷰 프로세스를 로드합니다.
...
1.  **Note Generation**:
    *   `resources/weekly-template.md`를 사용하여 주간 회고 노트(`30_Journal/Weekly/{YYYY-Www}.md`)를 생성합니다.
