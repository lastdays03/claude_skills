...
2.  **Context Loading**: `.agent/references/obsi_moc_builder/SKILL.md`를 읽어 'Top Down' 구조화 규칙을 확인합니다.
...
### 3단계: 생성 (Generation)
1.  **Drafting**:
    *   `.agent/references/obsi_moc_builder/moc-template.md`를 사용하여 MOC 파일을 생성합니다.
