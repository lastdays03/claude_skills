...
### 1단계: 진단 (Diagnosis)
1.  **Context Loading**: `.agent/references/obsi_knowledge_refiner/SKILL.md`를 읽어 'Gold Standard' 품질 기준을 확인합니다.
...
*   `.agent/references/obsi_knowledge_refiner/concept-template.md` 포맷에 맞춰 헤더를 재정비합니다.
