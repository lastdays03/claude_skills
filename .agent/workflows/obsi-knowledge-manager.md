...
1.  **Load Standards**: `.agent/references/obsi-knowledge-manager/SKILL.md`를 로드하여 품질 기준을 확인합니다.
...
1.  **Template**: `.agent/references/obsi-knowledge-manager/concept-template.md`를 참조하여 문서 구조(정의, 예시 등)를 잡습니다.
