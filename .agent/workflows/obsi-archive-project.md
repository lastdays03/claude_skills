...
1.  **Context Loading**: `.agent/references/obsi-archive-project/SKILL.md`를 읽어 종료 절차를 확인합니다.
...
### 3단계: 이관 (Move)
1.  **Manifest Creation**:
    *   `.agent/references/obsi-archive-project/manifest-template.md`를 사용하여 `_archive_meta.md`를 생성합니다. (종료 사유 등 기록)
2.  **Archive**:
