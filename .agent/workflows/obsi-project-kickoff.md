...
1.  **Context Loading**: `.agent/references/obsi-project-kickoff/SKILL.md`를 읽어 명명 규칙과 구조 표준을 로드합니다.
...
2.  **Overview Generation**:
    *   `.agent/references/obsi-project-kickoff/overview-template.md`를 사용하여 `Overview.md`를 생성합니다.
